...
new_breed_rank_all %>% 
  ...
  labs(title = "Breeds Ranked By Years", x = NULL, y =
         "Breeds")
```
> Assigned different colors for each rank manually. So that the rank could be more explicit and easier for the viewer to locate. For example, red for the highest rank, blue for the second highest.
